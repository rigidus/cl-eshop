...
(defun new-classes.unserialize-all ()
  ...
  (unserialize-from-file #P"/home/eviltosha/serialize_test/products_new7" (make-instance 'product))
  (unserialize-from-file #P"/home/eviltosha/serialize_test/groups5" (make-instance 'group))
  (unserialize-from-file #P"/home/eviltosha/serialize_test/filters2" (make-instance 'filter))
  (storage.make-lists)
