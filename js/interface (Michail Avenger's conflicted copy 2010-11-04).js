...
function rCalc() {
	...
	$('.cart').each(function(){
		...
		if(cnt > 0) {
			if (cnt == 1) {
				$(current).html('<i class="count"></i>&nbsp;товар на <i class="sum"></i> руб.');
			}
			else 
				if (cnt > 3) {
					$(current).html('<i class="count"></i>&nbsp;товаров на <i class="sum"></i> руб.');
				}
				else {
					$(current).html('<i class="count"></i>&nbsp;товара на <i class="sum"></i> руб.');
				}
