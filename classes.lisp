...
(new-classes.make-class-and-methods
 ...
 '((:name articul           :initarg :articul         :initform nil                          :accessor articul :disabled t :type string)
   ...
   (:name descr             :initarg :descr           :initform ""                           :accessor descr :disabled nil :type string)
   (:name shortdescr        :initarg :shortdescr      :initform ""                           :accessor shortdescr :disabled nil :type string)
